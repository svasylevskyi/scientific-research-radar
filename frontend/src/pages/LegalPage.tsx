...
const terms: Section[] = [
  ...
  { title: "Research results and their limitations", paragraphs: [
    ...
    "Runs start when requested manually or through a saved schedule and may fail or return no relevant results. Completed scheduled runs may be emailed to your profile address when email delivery is enabled. Stored history and feedback may influence later runs; substantially changing a topic can reduce continuity.",
  ] },
