...
class SandboxCheckout(Base):
    ...
    invoices_checked_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True))
    invoice_history_cursor: Mapped[str | None] = mapped_column(String(255))
    invoice_history_complete: Mapped[bool] = mapped_column(default=False)
